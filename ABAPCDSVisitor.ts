...
export interface ABAPCDSVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by `ABAPCDSParser.domain_string`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitDomain_string?: (ctx: Domain_stringContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `ABAPCDSParser.when_clause_complex`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitWhen_clause_complex?: (ctx: When_clause_complexContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `ABAPCDSParser.aggr_expr`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitAggr_expr?: (ctx: Aggr_exprContext) => Result;
